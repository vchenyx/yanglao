...
var search_count_url = basePath+"returnvisit/GetCountID.do ";//查询数量
var search_list_url = basePath+"returnvisit/getList.do";//查询数据集合
var find_by_id   = basePath+"returnvisit/findById.do"
var deal_ids = "";
var dept_option="";
init();
//searchDepartment();
	...
	$.ajax({
		...
		success:function(json){
			...
			for(var i in list){
				...
				html	+="<td><a href='javascript:;' onclick='callComplaint("+obj.id+")' data-id='1' data-opt='del' class='layui-btn layui-btn-danger layui-btn-mini'>回访</a></td>";
				html	+="</tr>";
			}
