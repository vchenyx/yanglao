...
function loadAllLocation(){
	$.ajax({
        url: basePath + "location/getAllPosi.do",    		
        type: "post",
        dataType : "json",
        async: false,
        success: function (json) {
        	...
        	html = "<tr onclick='javascript:info(this);'>"
				 + "<td>"+jsonData[0].pensionName+"</td>"
				 + "</tr>";
        	$(".site-table").find("tbody").html(html);*/
