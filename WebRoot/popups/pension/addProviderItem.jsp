	...
	<form class="layui-form">
		<div class="layui-form-item" style="margin-top:20px;">
			...
			<div class="layui-input-block">
				<input type="text" id="servicePro" placeholder="请输入服务项目" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
		<div class="layui-form-item" style="margin-top:20px;">
			<label class="layui-form-label" style="width:80px;"><font color="red" style="size:2px" >*</font>服务内容：</label>
			<div class="layui-input-block">
				<input type="text" id="serviceContent" placeholder="请输入服务内容" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
		<div class="layui-form-item" style="margin-top:20px;">
			<label class="layui-form-label" style="width:80px;"><font color="red" style="size:2px" >*</font>服务价格：</label>
			<div class="layui-input-block">
				<input type="text" id="unitPrice" placeholder="请输入服务价格" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
		<div class="layui-form-item" style="margin-top:20px;">
			<label class="layui-form-label" style="width:80px;"><font color="red" style="size:2px" >*</font>服务单位：</label>
			<div class="layui-input-block">
				<input type="text" id="serviceUnit" placeholder="请输入服务单位" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
		
		<div class="layui-form-item" style="margin-top:20px;">
			<label class="layui-form-label" style="width:80px;"><font color="red" style="size:2px" >*</font>服务标准：</label>
			<div class="layui-input-block">
				<input type="text" id="serviceStandard" placeholder="请输入服务标准" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
	</form>
	<script type="text/javascript"  src="<%=basePath %>back/js/jquery-1.8.3.min.js"></script> 
