	...
	<form class="layui-form">
			<div class="layui-form-item" style="margin-top:20px;">
				...
				<div class="layui-input-inline" style="width:191px;">
					<input type="text" id="name" placeholder="请输入老人姓名" autocomplete="off" class="layui-input" style="width:191px; margin-right:30px;">
				</div>
				<label class="layui-form-label" style="width:47px;"><font color="red" style="size:2px" >*</font>年龄：</label>
				<div class="layui-input-inline" style="width:191px;">
					<input type="text" id="age" placeholder="请输入老人年龄" autocomplete="off" class="layui-input" style="width:191px; margin-right:30px;">
				</div>
			</div>
			<div class="layui-form-item" style="margin-top:20px;">
			...
			<div class="layui-form-item" style="margin-top:20px;">
				...
				<div class="layui-input-inline" style="width:162px;">
					<input type="text" id="cellphone" placeholder="请输入老人手机号" autocomplete="off" class="layui-input" style="width:162px; margin-right:30px;">
				</div>
				<label class="layui-form-label" style="width:120px; padding-left: 0px"><font color="red" style="size:2px" >*</font>监护人手机号：</label>
				<div class="layui-input-inline" style="width:162px;">
					<input type="text" id="guardianPhone" placeholder="请输入监护人手机号" autocomplete="off" class="layui-input" style="width:162px; margin-right:30px;">
				</div>
			</div>
			<div class="layui-form-item" style="margin-top:20px;">
			...
			<div class="layui-form-item" style="margin-top:20px;">
				<label class="layui-form-label" style="width:80px;"><font color="red" style="size:2px" >*</font>上传照片：</label>
