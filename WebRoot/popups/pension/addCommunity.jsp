	...
	<form class="layui-form">
		<div class="layui-form-item" style="margin-top:20px;">
			...
			<div class="layui-input-block">
				<input type="text" id="name" placeholder="请输入社区名称" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
		<div class="layui-form-item" style="margin-top:20px;">
			<label class="layui-form-label" style="width:80px;"><font color="red" style="size:2px" >*</font>身份证号：</label>
			<div class="layui-input-block">
				<input type="text" id="address" placeholder="请输入社区地址" autocomplete="off" class="layui-input" style="width:400px; margin-right:30px;">
			</div>
		</div>
	</form>
	<script type="text/javascript"  src="<%=basePath %>back/js/jquery-1.8.3.min.js"></script> 
