					...
					<table class="site-table table-hover">
						...
						<tbody>
							<tr>
								...
								<td>糖尿病、高血压</td>
								<td>
									<a href="javascript:;" onclick="javascript:check();" class="layui-btn layui-btn-mini">查看所属医生</a>
								</td>
							</tr>
							<tr>
								<td>高淑敏</td>
...
<script type="text/javascript" src="<%=basePath %>static/js/medicalOlderInfo.js"></script>
</html>