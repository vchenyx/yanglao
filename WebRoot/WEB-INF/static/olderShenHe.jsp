					...
					<table class="site-table table-hover">
						...
						<tbody>
							<tr>
								...
								<td>糖尿病、高血压</td>
								<td>
									<a href="javascript:;" onclick="javascript:throughShenHe(this);" class="layui-btn layui-btn-mini">通过审核</a>
								</td>
							</tr>
							<tr>
								<td>高淑敏</td>
...
<script type="text/javascript" src="<%=basePath %>static/js/olderShenHe.js"></script>
</html>