...
<link rel="stylesheet" href="<%=basePath %>callcenter/css/bootstrap.min.css">
<script src="<%=basePath %>callcenter/js/jquery.min.js"></script>
<script src="<%=basePath %>callcenter/js/bootstrap/bootstrap.min.js"></script>
<script src="<%=basePath %>callcenter/js/sapoOCX.js"></script>
<script src="<%=basePath %>callcenter/js/webSocket.js"></script>
<script src="<%=basePath %>callcenter/js/index.js"></script>
</head>
...
<script type="text/javaScript">	
	...
	//连接服务器
	//sapoOcx.api.connect('124.205.241.254');
	sapoOcx.api.connect('47.92.24.251');
