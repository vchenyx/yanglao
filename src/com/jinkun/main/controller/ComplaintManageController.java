...
public class ComplaintManageController {
	...
	@RequestMapping("/SaveComplaintManage.do")
	@ResponseBody
	public JSONObject SaveComplaintManage(HttpSession session,Integer id,String cellphone,String acceptPerson,String handleDept,Long acceptTime,String complaintNumbers,
			String complaintPeople,String fuWuS,String fuWuSCellphone,String complaintContent,String manageContent, Integer selectId ) throws Exception {
		JSONObject json = new JSONObject();
		FComplaintInfo fcomplaintInfo =(FComplaintInfo) commonService.findByIntegerId(FComplaintInfo.class, id);
		fcomplaintInfo.setCellphone(cellphone);
		/*fcomplaintInfo.setAcceptPerson(acceptPerson);
		fcomplaintInfo.setHandleDept(handleDept);*/
		fcomplaintInfo.setAcceptTime(acceptTime);
		fcomplaintInfo.setComplaintNumbers(complaintNumbers);
		fcomplaintInfo.setComplaintPeople(complaintPeople);
		fcomplaintInfo.setFuWuS(fuWuS);
		fcomplaintInfo.setFuWuSCellphone(fuWuSCellphone);
		fcomplaintInfo.setComplaintContent(complaintContent);
		fcomplaintInfo.setManageContent(manageContent);
		fcomplaintInfo.setManageState(selectId);
		commonService.updateInfo(fcomplaintInfo);
